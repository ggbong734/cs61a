...
def key_of_min_value(d):
    ...
    """
    # BEGIN Question 0
    return min(d, key=d.get) # return the minimum key with the lowest value in the dict, function get() is applied to each key
    # END Question 0
...
def mean(s):
    ...
    # BEGIN Question 1
    "*** YOUR CODE HERE ***"
    assert len(s) != 0, "Empty sequence is not allowed"
    return sum(s)/len(s)
    # END Question 1